...
export default function FilterPanel({
  ...
  return (
    <div className="w-80 glass-card dark:glass-card-dark border-l border-slate-200 dark:border-slate-700 overflow-y-auto flex-shrink-0">
      <div className="p-6 sticky top-0 glass-card dark:glass-card-dark border-b border-slate-200 dark:border-slate-700 z-10">
