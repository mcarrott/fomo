...
export default function NewsFeed() {
  ...
  if (!enabled) {
    return (
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-6 h-full">
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-6 h-full flex flex-col">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
